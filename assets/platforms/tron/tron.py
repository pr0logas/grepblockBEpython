...
#:: Description: This file contains default values of the asset platform

# Defaults
database = "tron"
assetTicker="ETH"
assetName = "tron"
genesisBlock = 1438269988
coinGeckoStartUnixTime = 1440028800
blockTime = 15

parseBlocksInRangeFor = 999

chainProvider = 'http://116.202.49.92:8545'
